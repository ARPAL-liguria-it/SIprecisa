...
##
golem::fill_desc(
  pkg_name = "SIprecisa", # The Name of the package containing the App
  pkg_title = "SIprecisa", # The Title of the package containing the App
  pkg_description = "A shiny app for precision and bias calculations on analytical chemistry measurements", # The Description of the package containing the App
