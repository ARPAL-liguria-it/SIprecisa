...
-   il calcolo del bias o recupero di un metodo analitico, in condizioni ben definite;
...
a.   3.032 $\pm$ 0.041 ng/L
b.   20.43 $\pm$ 0.28 ng/L
c.   104.3 $\pm$ 5.1 ng/L

Le misure ottenute per i diversi campioni sono così riassunte:
a.   2.860, 3.113, 2.938, 3.107, 3.071, 2.838, 3.109, 3.088, 3.012, 2.746 ng/L;
b.   19.83, 19.10, 20.25, 20.16, 20.47, 19.12, 20.64, 22.26, 19.29, 21.77 ng/L;
c.   97.66, 107.7, 97.28, 103.3, 95.32, 99.46, 103.1, 110.3, 104.3, 95.49 ng/L.
