...
cat("**Operatori:** ", params$report04$expaim, "\n")
cat('\n\n<!-- -->\n\n')
```
...
```{r dataresults, echo=FALSE, results="asis", out.width='300px', fig.cap=paste0(sprintf("\\label{%s}", ordered_analytes), boxplot_text)}
